const email = "test" + Math.floor(Math.random() * 200) + "@gmaill.com";
...
describe("Registration", () => {
  ...
  it("User registration", () => {
    ...
    cy.get('[name="firstName"]').type("Ayoola");
    cy.get('[name="lastName"]').type("Ogunlowo");
    cy.get('[name="email"]').type(email);
    cy.get('[type="password"]').type("Sydney101");
